...
require "split_with_display_length/version"

Gem::Specification.new do |spec|
  spec.name          = "split_with_display_length"
  spec.version       = SplitWithDisplayLength::VERSION
  ...
  spec.homepage      = 'https://github.com/nyaahara/split_with_display_length'
  spec.license       = "MIT"
